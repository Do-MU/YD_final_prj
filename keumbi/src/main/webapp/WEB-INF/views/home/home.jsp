...
<body>
			...
			<div class="row welcome_inner">
				<div class="col-lg-6">
					<div class="welcome_text">
						...
						<br>이번 달 지출이 너무 많은데 어떻게 관리해야하지?
						<br>여러 은행과 카드사 수십 수백의 상품을 소비에 맞게 추천해드립니다!
						<br>나와 가장 알맞는 금융상품은 무엇인지 <span style="color:red">금비</span>를 통해 확인하세요</p>
						<div class="row">
							<div class="col-md-4">
								<div class="wel_item">
				...
				<div class="col-lg-6">
					<div class="tools_expert">
						<div class="skill_main">
							...
							<div class="skill_item">
								<h4>30대 사용자 <span class="counter">${cntUser.thirty}</span>%</h4>
								<div class="progress_br">
									<div class="progress">
							...
							<div class="skill_item">
								<h4>40대 사용자 <span class="counter">${cntUser.fourty}</span>%</h4>
								<div class="progress_br">
									<div class="progress">
							...
							<div class="skill_item">
								<h4>50대 사용자 <span class="counter">${cntUser.fifty}</span>%</h4>
								<div class="progress_br">
									<div class="progress">
							...
							<div class="skill_item">
								<h4>60대 이상 <span class="counter">${cntUser.over}</span>%</h4>
								<div class="progress_br">
									<div class="progress">
	...
	<section class="feature_area p_120">
		<div class="container">
			<div class="main_title">
				...
				<p>나랑 맞는 금융상품은 뭘까? 이 상품은 이자가 어떻게 되지?<br>빠르고 쉽게 KEUMBI가 알려줄 수 있어요!</p>
			</div>
			<div class="feature_inner row">
				<div class="col-lg-4 col-md-6">
					<div class="feature_item">
						<i class="bi bi-bank"></i>
						<h4>금융상품추천</h4>
						<p>다른 사람들은 어떤 금융상품을 사용할까? <br>사용자의 정보를 기반으로 추천해드려요! <br>계산기도 있어서 이자계산도 끄떡 없다구요!</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="feature_item">
						...
						<h4>가계부</h4>
						<p>거래/이체/결제내역까지 가계부는 금비가 쓸테니 걱정마세요! 당일 지출내역부터 당월 총 지출액까지!</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="feature_item">
						<i class="bi bi-card-checklist"></i>
						<h4>챌린지</h4>
						<p>소비가 많은 사용자를 위해 <br>지출을 줄일 수 있는 챌린지가 있어요! <br>시작이 어렵지만 도전하면 할만 할껄요? <br>우리 같이 소비를 줄여보자구요</p>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="testimonials_area p_120">
		<div class="container">
			<div class="main_title">
				<h2>금비가 처음이신가요?</h2>
				<p>금비는 사용자의 데이터를 기반으로 금융상품을 추천하고 있습니다. <br>회원들의 데이터를 종합하여 금융상품을 추천하는 금비 <br>지금 바로 시작하세요</p>
			</div>
			<div class="testi_inner">
				<div class="testi_slider owl-carousel">
					<div class="item">
						<div class="testi_item">
							<p>금융상품을 쉽게 비교하고 이자까지 계산되니까 간편하고 좋네요! 챌린지까지 할수있어서 절약도 되는 것 같아요</p>
							<h4>rks*****</h4>
					...
					<div class="item">
						<div class="testi_item">
							<p>가계부 없이 돈을 썼었는데 자동으로 기입되니 어디에 많이 썼는지 보이고 절약도 되는 것 같아서 괜찮네요</p>
							<h4>min*****</h4>
							<a href="#"><i class="fa fa-star"></i></a> <a href="#"><i
								class="fa fa-star"></i></a> <a href="#"><i class="fa fa-star"></i></a>
							<a href="#"><i class="fa fa-star"></i></a> <a href="#"><i
					...
					<div class="item">
						<div class="testi_item">
							<p>요즘 바빠서 은행 갈 시간도 없었는데 알아보기도 쉽고 간편해서 좋습니다. 근데 카드는 이게 다 인가요?</p>
							<h4>par*****</h4>
							<a href="#"><i class="fa fa-star"></i></a> <a href="#"><i
								class="fa fa-star"></i></a> <a href="#"><i class="fa fa-star"></i></a>
							<a href="#"><i class="fa fa-star"></i></a> <a href="#"><i
					...
					<div class="item">
						<div class="testi_item">
							<p>통장추천은 괜찮은데 카드 수가 많이 없네요 그래도 추천은 내 지출이랑 맞아서 괜찮은 것 같아요 </p>
							<h4>hyo*****</h4>
							<a href="#"><i class="fa fa-star"></i></a> <a href="#"><i
								class="fa fa-star"></i></a> <a href="#"><i class="fa fa-star"></i></a>
							<a href="#"><i class="fa fa-star"></i></a> <a href="#"><i
